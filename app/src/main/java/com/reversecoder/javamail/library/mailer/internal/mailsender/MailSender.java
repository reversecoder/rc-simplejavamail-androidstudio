package com.reversecoder.javamail.library.mailer.internal.mailsender;
...
import com.reversecoder.javamail.library.mailer.internal.socks.AuthenticatingSocks5Bridge;
import com.reversecoder.javamail.library.mailer.internal.socks.socks5server.AnonymousSocks5Server;
...
import static com.reversecoder.javamail.library.converter.EmailConverter.mimeMessageToEML;
...
//	 */
	...
	public MailSender(final Session session, final ProxyConfig proxyConfig, final TransportStrategy transportStrategy) {
		...
		this.threadPoolSize = ConfigLoader.valueOrProperty(null, ConfigLoader.Property.DEFAULT_POOL_SIZE, DEFAULT_POOL_SIZE);
