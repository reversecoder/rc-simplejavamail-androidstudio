...
import com.reversecoder.javamail.library.util.SimpleJavaMailProperties;
...
import static com.reversecoder.javamail.library.internal.util.MiscUtil.extractEmailAddresses;
...
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_BCC_ADDRESS;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_BCC_NAME;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_CC_ADDRESS;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_CC_NAME;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_FROM_ADDRESS;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_FROM_NAME;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_REPLYTO_ADDRESS;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_REPLYTO_NAME;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_SUBJECT;
//import static com.reversecoder.javamail.library.util.ConfigLoader.Property.DEFAULT_TO_ADDRESS;
...
public class EmailBuilder {
	...
	SimpleJavaMailProperties javaMailProperties;

	public EmailBuilder(Context context) {
		mContext = context;
		javaMailProperties = new SimpleJavaMailProperties(mContext);
		recipients = new ArrayList<>();
		embeddedImages = new ArrayList<>();
		attachments = new ArrayList<>();
		headers = new HashMap<>();

		if (javaMailProperties.hasProperty(javaMailProperties.defFromAddress)) {
			from(javaMailProperties.defFromName, javaMailProperties.defFromAddress);
		}
