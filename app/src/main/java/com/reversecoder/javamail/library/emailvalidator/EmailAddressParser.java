package com.reversecoder.javamail.library.emailvalidator;
...
public final class EmailAddressParser {
	 ...
	 */
	public static boolean isValidReturnPath(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria) {
		return (email != null) && com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).RETURN_PATH_PATTERN.matcher(email).matches();
	}
	 ...
	 */
	public static String getReturnPathBracketContents(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria) {
		if (email == null) {
			return (null);
		}
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).RETURN_PATH_PATTERN.matcher(email);
		if (m.matches()) {
			return (m.group(1));
		} else {
			return (null);
	 ...
	 */
	public static String getReturnPathAddress(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		if (email == null) {
			return (null);
		}
	 ...
	 */
	public static boolean isValidMailboxList(String header_txt, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria) {
		return (com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).MAILBOX_LIST_PATTERN.matcher(header_txt).matches());
	}
	 ...
	 */
	public static boolean isValidAddressList(String header_txt, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria) {
		...
		boolean valid = false;
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).ADDRESS_PATTERN.matcher(header_txt);
	 ...
	 * @param extractCfwsPersonalNames See {@link EmailAddressParser}
	 */
	public static InternetAddress getInternetAddress(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		if (email == null) {
			return (null);
		}
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).MAILBOX_PATTERN.matcher(email);
		if (m.matches()) {
	 ...
	 */
	public static String[] getAddressParts(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		if (email == null) {
			return (null);
		}
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).MAILBOX_PATTERN.matcher(email);
	 ...
	 * @param extractCfwsPersonalNames See {@link EmailAddressParser}
	 */
	public static String getPersonalName(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		if (email == null) {
			return (null);
		}
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).MAILBOX_PATTERN.matcher(email);
	 ...
	 * @param extractCfwsPersonalNames See {@link EmailAddressParser}
	 */
	public static String getLocalPart(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		if (email == null) {
			return (null);
		}
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).MAILBOX_PATTERN.matcher(email);
	 ...
	 * @param extractCfwsPersonalNames See {@link EmailAddressParser}
	 */
	public static String getDomain(String email, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		if (email == null) {
			return (null);
		}
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).MAILBOX_PATTERN.matcher(email);
	 ...
	 */
	public static InternetAddress[] extractHeaderAddresses(String header_txt, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		...
		com.reversecoder.javamail.library.emailvalidator.Dragons dragons = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria);
	 ...
	 * @param extractCfwsPersonalNames See {@link EmailAddressParser}
	 */
	public static InternetAddress pullFromGroups(Matcher m, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
	 ...
	 */
	public static String[] getMatcherParts(Matcher m, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria, boolean extractCfwsPersonalNames) {
		...
		final boolean allowDomainLiterals = criteria.contains(com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria.ALLOW_DOMAIN_LITERALS);
		if (criteria.contains(com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria.ALLOW_QUOTED_IDENTIFIERS)) {
		...
		String test_addr = removeAnyBounding('"', '"', current_localpart) +
				"@" + current_domainpart;
		if (com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).ADDR_SPEC_PATTERN.matcher(test_addr).matches()) {
	 ...
	 */
	public static String getFirstComment(String text, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria) {
		if (text == null) {
			return (null); // important
		}
		Matcher m = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria).COMMENT_PATTERN.matcher(text);
		if (!m.find()) {
			return (null);
		}
	 ...
	 */
	public static String cleanupPersonalString(String string, EnumSet<com.reversecoder.javamail.library.emailvalidator.EmailAddressCriteria> criteria) {
		if (string == null) {
			return null;
		}
		String text = string.trim();
		final com.reversecoder.javamail.library.emailvalidator.Dragons dragons = com.reversecoder.javamail.library.emailvalidator.Dragons.fromCriteria(criteria);
