package com.reversecoder.javamail.library.converter;
...
import static com.reversecoder.javamail.library.converter.internal.mimemessage.MimeMessageHelper.produceMimeMessage;
import com.reversecoder.javamail.library.converter.internal.mimemessage.MimeMessageParser;
import com.reversecoder.javamail.library.converter.internal.msgparser.OutlookMessageParser;
...
import static com.reversecoder.javamail.library.internal.util.MiscUtil.extractCID;
...
/**
 * Utility to help convert {@link com.reversecoder.javamail.library.email.Email} instances to other formats (MimeMessage, EML etc.) and vice versa.
 */
